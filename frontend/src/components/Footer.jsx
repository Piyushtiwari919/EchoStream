...
const Footer = () => {
  return (
    <footer className="footer sm:footer-horizontal bg-success-content text-neutral-content py-4 px-8 bottom-0 flex justify-between items-center">
      <aside>
        <Link to="/browse">
          <p className="text-2xl m-0 font-bold">EchoStream</p>
          Explore Freely
        </Link>
      </aside>
      <nav>
        ...
        <div className="grid grid-flow-col gap-4">
          <a
            href="https://www.linkedin.com/in/piyush-tiwari919/"
            target="_blank"
          >
            <svg
          ...
          <a
            href="https://github.com/Piyushtiwari919/EchoStream"
            target="_blank"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
